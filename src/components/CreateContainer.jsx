    ...
    <div className='w-full min-h-screen flex items-center justify-center'>
      ...
      {fields && (
          ...
          <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
              ...
              <input type="text" required onChange={(e) => setTitle(e.target.value)} value={title} placeholder='Give me a title...' className=' w-full h-full text-lg bg-transparent font-semibold outline-none border-none placeholder:text-gray-400 text-textColor' />
          </div>
