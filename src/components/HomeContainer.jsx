    ...
    <section className=' grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <p className=' text-base text-textColor text-center md:text-left md:w-[80%]'>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit ad explicabo tempora veritatis eaque, nesciunt cupiditate consectetur laborum. Pariatur adipisci beatae nam eligendi praesentium quisquam quasi laboriosam, dicta accusantium distinctio!
        </p>
      ...
      <div className="py-2 flex-1 flex items-center relative">
            ...
            <div className=' w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-32 py-4 gap-4 flex-wrap'>
                {heroData && heroData.map(n =>(
                    ...
                    <img src={n.imgageSrc} className='w-20 lg:w-40 -mt-10 lg:-mt-20 ' alt="I1" />
                    <p className='text-base lg:text-xl font-semibold mt-2 lg:mt-4'>{n.name}</p>
